...
- Compact One Page Task Chip Utility turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact one-page Task Chip utility. It should show a title, one input for a short task, an add icon button, saved task chips with remove icon buttons, localStorage persistence, and visible empty/error states. Keep it simple, mobile usable, and interactive.
...
- Record Operations - Compact One Page Task Chip Utility
- Record Editor - Compact One Page Task Chip Utility
- Empty and Error Recovery - Compact One Page Task Chip Utility

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Compact One Page Task Chip Utility
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Compact One Page Task Chip Utility
...
SCREEN_SPEC_3:
- exact_screen_title: Empty and Error Recovery - Compact One Page Task Chip Utility
